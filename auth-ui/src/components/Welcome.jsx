      ...
      <div className="mx-auto w-full max-w-3xl text-center space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 pt-2">
          <button
            ...
            className="w-full sm:w-48 rounded-xl bg-blue-600 text-white px-6 py-3 text-base sm:text-lg font-medium shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400"
          >
            Prompt
          </button>
          <button
            onClick={onClickImage}
            className="w-full sm:w-48 rounded-xl bg-slate-200 text-slate-900 px-6 py-3 text-base sm:text-lg font-medium shadow-md hover:bg-slate-300 focus:outline-none focus:ring-2 focus:ring-slate-300"
          >
            Text to Image Generation
          </button>
          <button
            onClick={onClickDashboard}
            className="w-full sm:w-48 rounded-xl bg-green-600 text-white px-6 py-3 text-base sm:text-lg font-medium shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-400"
          >
            Dashboard
          </button>
        </div>
